                    ...
                    <div class="container">
                        <div class="row justify-content-between">
                            ...
                            <div id="datosContacto" class="col-12 col-md-5 txtGris">
                                ...
                                <p><a class="txtCeleste" href="mailto:carloschaparro@nafra.com.ar">carloschaparro@nafra.com.ar</a></p>

                                <h5 class="pt-2">Emisión:</h5>
                                <p><a class="txtCeleste" href="mailto:ramirofailo@nafra.com.ar">ramirofailo@nafra.com.ar</a></p>

                                <h5 class="pt-2">Siniestros:</h5>
                                <p><a class="txtCeleste" href="mailto:rodrigopalavecino@nafra.com.ar">rodrigopalavecino@nafra.com.ar</a></p>

                                <h5 class="pt-2">Administración de ventas y cobranzas:</h5>
                                <p><a class="txtCeleste" href="mailto:cobranzas@nafra.com.ar">cobranzas@nafra.com.ar</a></p>
