...
// 
//     const accessToken = state.session.infoAutoAccessToken;
// 
...
//     accessToken: state.session.infoAutoAccessToken,
//     refreshToken: state.session.infoAutoRefreshToken,
//   };
// 
...
//     // Update access token
//     state.setSession({ ...state.session, infoAutoAccessToken: resultBody });
//   }
// };
// 
